...
const ApplicationFormSchema = new mongoose.Schema(
  {
    ...
    passportCopy: { url: String, public_id: String },
    sscCertificate: { url: String, public_id: String },
    hscCertificate: { url: String, public_id: String },
    otherFiles: { url: String, public_id: String },
    remarks: { type: String },
    status: {
      type: String,
